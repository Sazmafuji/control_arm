...
static size_t _AskSta_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_AskSta_Request(full_bounded, is_plain, 0);
...
static size_t _AskSta_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_AskSta_Response(full_bounded, is_plain, 0);
