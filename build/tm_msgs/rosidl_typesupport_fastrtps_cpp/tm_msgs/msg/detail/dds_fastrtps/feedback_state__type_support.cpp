  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.joint_tor_average;
  }
  // Member: joint_tor_min
  {
    cdr << ros_message.joint_tor_min;
  }
  // Member: joint_tor_max
  {
    cdr << ros_message.joint_tor_max;
  }
  // Member: robot_link
  ...
  size_t current_alignment)
{
  ...
  // Member: joint_tor_average
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.joint_tor_average[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: joint_tor_min
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.joint_tor_min[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: joint_tor_max
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.joint_tor_max[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: robot_link
...
static size_t _FeedbackState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FeedbackState(full_bounded, is_plain, 0);
