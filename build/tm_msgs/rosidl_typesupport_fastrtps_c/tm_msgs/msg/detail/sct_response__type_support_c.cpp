...
#include "tm_msgs/msg/detail/sct_response__rosidl_typesupport_fastrtps_c.h"
...
using _SctResponse__ros_msg_type = tm_msgs__msg__SctResponse;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SctResponse__ros_msg_type * ros_message = static_cast<const _SctResponse__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SctResponse__ros_msg_type * ros_message = static_cast<_SctResponse__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _SctResponse__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tm_msgs__msg__SctResponse(
...
static size_t _SctResponse__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tm_msgs__msg__SctResponse(
...
static message_type_support_callbacks_t __callbacks_SctResponse = {
  "tm_msgs::msg",
  "SctResponse",
...
static rosidl_message_type_support_t _SctResponse__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SctResponse,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tm_msgs, msg, SctResponse)() {
  return &_SctResponse__type_support;
}
