...
static const _Mpu_type_support_symbol_names_t _Mpu_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_store, msg, Mpu)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_store, msg, Mpu)),
  }
};
...
{
  return &::msg_store::msg::rosidl_typesupport_cpp::Mpu_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msg_store, msg, Mpu)() {
  return get_message_type_support_handle<msg_store::msg::Mpu>();
}
