...
#include "msg_store/msg/detail/mpu__rosidl_typesupport_fastrtps_c.h"
...
using _Mpu__ros_msg_type = msg_store__msg__Mpu;
...
static uint32_t _Mpu__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_store__msg__Mpu(
...
static size_t _Mpu__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_store__msg__Mpu(
